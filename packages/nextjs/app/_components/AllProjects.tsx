    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          <h4>All Projects</h4>
          {totalProjects !== undefined && <span className="badge rounded-full mt-px">{Number(totalProjects)}</span>}
        </div>
      </div>
      ...
      <div className="flex gap-2 mb-6">
        <button
          ...
          className={`btn btn-sm ${filterStatus === "all" ? "btn-secondary" : "btn-ghost"}`}
        >
          All
        </button>
        <button
          onClick={() => setFilterStatus("proposals")}
          className={`btn btn-sm ${filterStatus === "proposals" ? "btn-secondary" : "btn-ghost"}`}
        >
          Proposals
        </button>
        <button
          onClick={() => setFilterStatus("completed")}
          className={`btn btn-sm ${filterStatus === "completed" ? "btn-secondary" : "btn-ghost"}`}
        >
          Completed
        </button>
      </div>
